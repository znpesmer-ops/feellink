...
declare class Index<T extends Record<string, any> = Record<string, any>> {
     ...
     * @returns Promise containing an EnqueuedTask or null
     */
    updateProximityPrecision(proximityPrecision: ProximityPrecision): Promise<EnqueuedTask>;
    /**
     * Reset the proximity precision settings to its default value
     *
     * @returns Promise containing an EnqueuedTask
     */
    resetProximityPrecision(): Promise<EnqueuedTask>;
    /**
     ...
     * @returns Promise containing an EnqueuedTask or null
     */
    updateEmbedders(embedders: Embedders): Promise<EnqueuedTask>;
    /**
