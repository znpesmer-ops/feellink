...
export interface NestQueueEventOptions extends PartialThisParameter<QueueEventsOptions, 'connection'> {
    /**
     * @deprecated
...
//# sourceMappingURL=queue-event-options.interface.d.ts.map