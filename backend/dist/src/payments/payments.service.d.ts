...
export declare class PaymentsService {
    ...
    private static readonly PLAN_PRICES_TRY;
    private static readonly EXTRA_PRICES_TRY;
    private static readonly PLAN_ROLE_MAP;
    private static readonly EXTRA_ROLE_MAP;
