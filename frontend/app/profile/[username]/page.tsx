            ...
            {isLoadingPosts ? (
              ...
              <div className="p-4">
                <p className="text-xs text-gray-400 dark:text-gray-500 mb-3">
                  {profileArtworksBase.filter((a: any) => a.media?.length > 0 && a.media[0]?.url).length} eser · Tur butonuyla 3D galeride gez
                </p>
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                  {profileArtworksBase.filter((a: any) => a.media?.length > 0 && a.media[0]?.url).map((artwork: any) => (
                    <div
                      key={artwork.id}
